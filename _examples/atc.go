...
// Missing ATC_CREATE in GOSDK examples (in ../docs/get-details/atc.md:40)
// Missing ATC_ADD_TRANSACTION in GOSDK examples (in ../docs/get-details/atc.md:117)
// Missing ATC_CONTRACT_INIT in GOSDK examples (in ../docs/get-details/atc.md:257)
