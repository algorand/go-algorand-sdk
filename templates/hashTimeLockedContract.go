...
//----------
//owner : string
//an address that can receive the asset after the expiry round
//receiver: string
//address to receive Algos
//hashFunction : string
//the hash function to be used (must be either sha256 or keccak256)
//hashImage : string
//the hash image in base64
//expiryRound : uint64
//the round on which the assets can be transferred back to owner
//maxFee : uint64
//the maximum fee that can be paid to the network by the account
